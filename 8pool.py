...
cue_image = pygame.image.load('8-POOL-PYTHON/assets/images/cue.png').convert_alpha()
t_image = pygame.image.load('8-POOL-PYTHON/assets/images/table.png').convert_alpha()
balls_imgs = []

for imo in range(1, 17):
    ball_img = pygame.image.load('8-POOL-PYTHON/assets/images/ball_' + str(imo) + '.png').convert_alpha()
